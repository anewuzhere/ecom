		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="calendar.php"><i class="glyphicon glyphicon-edit"></i> Manage Schedule</a></li>
                    <li><a href="stats.php"><i class="glyphicon glyphicon-edit"></i> Manage Driver</a></li>
                    <li><a href="tables.php"><i class="glyphicon glyphicon-edit"></i> Manage Customer</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-edit"></i> Manage Booking</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-edit"></i> Manage Conductor</a></li>
                    <li class="submenu">
                         <a href="#">
