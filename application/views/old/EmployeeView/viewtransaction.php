 ...
 <div class="card">
	            <div class="card-header" style="background-color:#0DB3A1; border-color:#0DB3A1">
	               <center> <h4 class="card-title" style="color:white;">Current Travel Transaction</h4></center>
	                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
        <div class="heading-elements">
                        <a href="<?= base_url() . 'EmployeeController/cancelTransaction/' . $u->transaction_id ?>"> Cancel Travel</a>
                        <?php if($u->status == "On hold"){ ?>
                        <a href="<?= base_url() . 'EmployeeController/verifyTransaction/' . $u->transaction_id ?>"> Verify</a>
                        <?php   } ?>
											...
											<div class="modal-content">
                                              ...
                                              <center>  <img src="<?= base_url() . 'images/receipts/' . $u->picpath ?>" width = "500" height="500" alt="..." class="img-thumbnail"> </center>
                                                <?php }else{  ?>
                                                    ...
                                                    <?php  } ?>
												<form method="POST" action="<?= base_url().'EmployeeController/verifyPayment/'.$u->transaction_id?>">
													...
													<div class="form-group">
							                            <input value="<?=date("Y-m-d, h:i:sa",$u->end_date)?>" type="date" placeholder="" class="form-control input-md">
                                                    </div>
