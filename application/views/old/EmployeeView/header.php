...
<html>
  <head>
    ...
    <meta name="description" content="Robust Employee is super flexible, powerful, clean &amp; modern responsive bootstrap 4 Employee template with unlimited possibilities.">
    <meta name="keywords" content="Employee template, robust Employee template, dashboard template, flat Employee template, responsive Employee template, web app">
    <meta name="author" content="PIXINVENT">
    <title>Travel Now Asia - Online Booking System</title>
          ...
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"> <i></i></span><span class="user-name"><?=$this->session->last_name?>, <?=$this->session->first_name?></span></a>
                <div class="dropdown-menu dropdown-menu-right"><a href="<?= base_url() . "EmployeeController/editUser/" ?>" class="dropdown-item"><i class="icon-head"></i> Edit Profile</a><a href="#" class="dropdown-item"><i class="icon-mail6"></i>User Logs</a><a href="<?= base_url() . "EmployeeController/userlog" ?>" class="dropdown-item"><i class="icon-clipboard2"></i> Task</a><a href="#" class="dropdown-item"><i class="icon-calendar5"></i> Calender</a>
                  <div class="dropdown-divider"></div><a href=<?php echo base_url().'EmployeeController/logout'?> class="dropdown-item"><i class="icon-power3"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                    <li class="nav-item"><a href=<?php echo base_url().'EmployeeController/index'?>><i class="icon-home3"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Dashboard</span></a>
            </li>
           ...
           <li class=" nav-item"><a href="index.html"><i class="icon-address-book"></i><span data-i18n="nav.dash.main" class="menu-title">Customer Management</span></a>
            <ul class="menu-content">
              <li><a href=<?php echo base_url().'EmployeeController/client'?> data-i18n="nav.dash.main" class="menu-item">View Customer</a>
              </li>
              </ul>
          </li>
          ...
          <li class=" nav-item"><a href="index.html"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Service Management</span></a>
            <ul class="menu-content">
              <li><a href=<?php echo base_url().'EmployeeController/packagelist'?> data-i18n="nav.dash.main" class="menu-item">Tour Package</a>
              </li>
              </ul>
          </li>
            ...
            <ul class="menu-content">
              <li><a href=<?php echo base_url().'EmployeeController/transactionlist'?> data-i18n="nav.dash.main" class="menu-item">Transactions</a>
              </li>
              <li><a href=<?php echo base_url().'EmployeeController/transactionalllist'?> data-i18n="nav.dash.main" class="menu-item">Booking List</a>
              </li>
            </ul>
          </li>
         
       
          <li class="nav-item"><a href=<?php echo base_url().'EmployeeController/forcasting/2018'?>><i class="icon-area-chart"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Sales Forcasting</span></a>
            </li>
        </ul>
      </div>
      <!-- /main menu content-->
