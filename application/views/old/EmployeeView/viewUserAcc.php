 ...
 <div class="card">
	            <div class="card-header" style="background-color:#FE5722; border-color:#FE5722">
	               <center> <h4 class="card-title" style="color:white;">USER DETAILS</h4></center>
	                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
        <div class="heading-elements">
                        <a href="<?= base_url() . 'EmployeeController/editAcc/' . $u->account_id ?>">Edit Profile</a>
	                </div>
	            </div>
	            <div class="card-body collapse in">
	                <div class="card-block">
...
<center><td><a href="<?= base_url() . 'EmployeeController/users/'?>" class="btn btn-warning">BACK</i></a><td></center>
