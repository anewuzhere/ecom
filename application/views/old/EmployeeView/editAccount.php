 ...
 <div class="card">
	            <div class="card-header" style="background-color:#FE5722; border-color:#FE5722">
	               <center> <h4 class="card-title" style="color:white;">USER DETAILS</h4></center>
	                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
        <div class="heading-elements">
             <a href="<?= base_url() . 'EmployeeController/deleteUser/' . $u->account_id ?>">Delete Account</a>
	                </div>
	            </div>
	            <div class="card-body collapse in">
	                <div class="card-block">
                    ...
                    <form class="form" name="myform" method="POST" action="<?= base_url().'EmployeeController/do_editAcc/'?>">
	                    	<div class="form-body">
                             <?= form_hidden('id', $u->account_id); ?>  
                              ...
                              <br>
                                ...
                                <div class="form-group">
                                        ...
                                        <option <?php if($u->access_lvl == "Employeeistrator"){echo 'selected';}?> value="Employeeistrator">Employeeistrator</option>
...
<a href="<?= base_url() . 'EmployeeController/users/'?>" class="btn btn-warning">BACK</a></center>
