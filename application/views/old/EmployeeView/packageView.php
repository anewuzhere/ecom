    ...
    <div class="card-header">
        ...
        <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
            ...
            <ul class="list-inline mb-0">
                ...
                <li><a <a href="<?= base_url() . 'EmployeeController/addPackage/'?>"><i class="icon-plus"></i></a></li>
            </ul>
        </div>
    </div>
            ...
            <div class="card-text">
                <table class="table" id="mytable">
                                ...
                                <?php foreach($user as $u){ ?>
                                    <tr>
                                    <td><a href="<?= base_url() . "EmployeeController/viewPackage/".$u->package_id ?>"><?= $u->package_name ?> </a></td>
