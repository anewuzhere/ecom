<section id="global-settings" class="card">
    <div class="card-header">
        ...
        <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
            ...
            <ul class="list-inline mb-0">
                <li><a href="<?= base_url() . 'EmployeeController/deleteInclusion/'.$inc->inc_id?>" onclick ="return confirm('Do you really want to Delete?');" ><i class="icon-trash"></i></a></li>
            </ul>
        </div>
    </div>
    <div class="card-body collapse in">
        <div class="card-block">
            <div class="card-text">
                        <form class="form" name="myForm" method="POST" onsubmit="return validateForm()" action="<?= base_url().'EmployeeController/do_editInclusion/'?>">
                                <div class="col-md-8">
