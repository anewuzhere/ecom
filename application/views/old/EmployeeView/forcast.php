                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            <a href="<?= base_url() . "EmployeeController/forcasting/".date("Y",strtotime('- 4 year',time())) ?>"  class="btn btn-secondary btn-hover upgrade-to-pro"><?php echo date("Y",strtotime('- 4 year',time())) ?></a>
                            <a href="<?= base_url() . "EmployeeController/forcasting/".date("Y",strtotime('- 3 year',time())) ?>"  class="btn btn-secondary btn-hover upgrade-to-pro"><?php echo date("Y",strtotime('- 3 year',time())) ?></a>
                            <a href="<?= base_url() . "EmployeeController/forcasting/".date("Y",strtotime('- 2 year',time())) ?>"  class="btn btn-secondary btn-hover upgrade-to-pro"><?php echo date("Y",strtotime('- 2 year',time())) ?></a>
                            <a href="<?= base_url() . "EmployeeController/forcasting/".date("Y",strtotime('- 1 year',time())) ?>"  class="btn btn-secondary btn-hover upgrade-to-pro"><?php echo date("Y",strtotime('- 1 year',time())) ?></a>
                            <a href="<?= base_url() . "EmployeeController/forcasting/".date("Y") ?>"  class="btn btn-secondary btn-hover upgrade-to-pro"><?php echo date("Y") ?></a>
                        </ul>
                    </div>
                </div>
				<?php
