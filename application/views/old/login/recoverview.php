...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Recover Password - Travel Now Asia</title>
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column  blank-page blank-page" background="<?php echo base_url().'app-assets/images/logo/travelnowasialogo.png';?>">
    <!-- ////////////////////////////////////////////////////////////////////////////-->
        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="<?php echo base_url().'app-assets/images/logo/travelnowasialogo.png';?>" alt="branding logo"></div>
                </div>
            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    <form class="form-horizontal" action="login-simple.html" novalidate>
                        ...
                        <button type="submit" class="btn btn-secondary btn-lg btn-block"><i class="icon-lock4"></i> Recover Password</button>
                    </form>
                </div>
            </div>
            <div class="card-footer">
                <div class="card-footer no-border">
                <p class="float-sm-left text-xs-center"><a href='<?= base_url()."Login/logon"?>' class="card-link">Login</a></p>
